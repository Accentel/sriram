										...
										<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                  <!--  <select  name="ptype" id="ptype" class="form-control" required onchange="showuser(this.value);">
													...
													</select>-->									<input type="radio" name="ptype" value="OP" onClick="window.location.href='labbill.php';"/>&nbsp;OP&nbsp;<input type="radio" name="ptype" value="IP" onClick="window.location.href='iplabbill.php';"/>&nbsp;IP&nbsp;<input type="radio" name="ptype" value="General" checked/> General
													</div>
