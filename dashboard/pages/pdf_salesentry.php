...
$pdf->Cell(10, 6,'S.no', 0, 0, 'C', FALSE);
$pdf->Cell(20, 6, 'Date', 0, 0, 'C', FALSE);
...
if($prdcode != "")	
{
	$qry1=mysqli_query($link,"select c.product_code,c.product_name,b.cust_name,a.u_qty,a.value,b.lr_no,batch_no,b.sal_date from phr_salent_dtl as a,phr_salent_mast as b,phr_purinv_dtl as c where a.lr_no=b.lr_no and a.inv_id=c.inv_id and b.sal_date between '$sdate' and '$edate' and c.PRODUCT_CODE='$prdcode'");

}
else if($ctype != "" && $cname != ""){
	$qry1=mysqli_query($link,"select c.product_code,c.product_name,b.cust_name,a.u_qty,a.value,b.lr_no,batch_no,b.sal_date from phr_salent_dtl as a,phr_salent_mast as b,phr_purinv_dtl as c where a.lr_no=b.lr_no and a.inv_id=c.inv_id and b.sal_date between '$sdate' and '$edate' and b.customer_type='p' and b.consultant_name='$cname'");

}else if($ctype != "" && $cname1 != ""){
	$qry1=mysqli_query($link,"select c.product_code,c.product_name,b.cust_name,a.u_qty,a.value,b.lr_no,batch_no,b.sal_date from phr_salent_dtl as a,phr_salent_mast as b,phr_purinv_dtl as c where a.lr_no=b.lr_no and a.inv_id=c.inv_id and b.sal_date between '$sdate' and '$edate' and b.customer_type='c' and b.consultant_name='$cname1'");

}else {
$qry1=mysqli_query($link,"select c.product_code,c.product_name,b.cust_name,a.u_qty,a.value,b.lr_no,batch_no,b.sal_date from phr_salent_dtl as a,phr_salent_mast as b,phr_purinv_dtl as c where a.lr_no=b.lr_no and a.inv_id=c.inv_id and b.sal_date between '$sdate' and '$edate'");
...
$count++;
$pdf->SetFont('Arial','',10);
$pdf->Cell(10, 6,$count, 0, 0, 'C', FALSE);
$pdf->Cell(20, 6, $row1[7], 0, 0, 'C', FALSE);
