...
$sql=mysqli_query($link,"select * from `bill` where billno='$id'");
  ...
  <tr>
    <td colspan="2" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
		...
		<tr><td>#10-2-67/68, Mayuri Center, Kahammam.</td></tr>
	...
	<table width="93%" border="1" align="left" style="vertical-align:text-top; margin-top-10px;" cellpadding="1" cellspacing="0">
			...
			<?php	
				 $sql1="SELECT testname,amount FROM bill1 WHERE bno = '$id'";
