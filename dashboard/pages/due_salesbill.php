                            ...
                            <div class="card card-box">
                                ...
                                <div class="card-body" id="bar-parent">
                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
                                        <?php
                                        $id=$_GET['id'];
                                        $rst=mysqli_query($link,"select * from phr_salent_mast where lr_no='$id'") or die(mysqli_error($link));
                                        
                                        foreach($rst as $key => $res){
											$bdate1 = str_replace('-', '/', ($res['sal_date']));
											$bdate=date('d/m/Y', strtotime($bdate1));
											$tamount=$res['tamount'];
											$discount=$res['discount'];
											$namount=$res['final_amnt'];
											$pamount=$res['final_paid'];
											$bamount=$res['bal'];
											$remarks=$res['remarks'];
											$paymenttype=$res['paymenttype'];
											$ptype=$res['customer_type'];
											$mrno=$res['mrnum'];
											$kk=mysqli_query($link,"select patientname from patientregister where registerno='$mrno'");
										...
										<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
													...
													<option value="p1" <?php if($ptype=="p1"){echo 'selected';} ?>>OP</option>
													<option value="p" <?php if($ptype=="p"){echo 'selected';} ?>>IP</option>
													<option value="c" <?php if($ptype=="c"){echo 'selected';} ?>>Customer</option>
													</select>													
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="mrno"   id="mrno" placeholder="Enter MRNO" class="form-control mrno" readonly value="<?php echo $mrno=$res['mrnum']; ?>" required /> 
													 </div>
                                        </div>
										<?php }else{}?>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" name="bno" data-required="1" id="bno" placeholder="Enter Bill No" class="form-control" value="<?php echo $res['INV_NO']; ?>" readonly/>
													 <input type="hidden" name="user"  id="user"  class="form-control" value="<?php echo $ses; ?>" />
													 <input type="hidden" name="id"  id="id"  class="form-control" value="<?php echo $res['LR_NO']; ?>" />
													</div>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="pname" data-required="1" id="pname"  placeholder="Enter Patient Name" class="form-control" required value="<?php echo $pname; ?>" readonly/> 
                                            ...
                                            <label class="control-label col-md-2">Doctor Name
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="dname"  id="dname" placeholder="Enter Doctor Name" class="form-control" value="<?php echo $res['Consultant_Name']; ?>" readonly/> </div>
                                           ...
                                           <div class="form-actions">
                                            <div class="row">
                                                <div class="offset-md-3 col-md-9">
                                                    ...
                                                    <a href="salesentry_list.php"><button type="button" class="btn btn-default">Cancel</button></a>
                                                </div>
                                            	</div>
                                        	</div>
										</div>
