...
window.onload=GetClock;
 ...
 $patno=$_GET['pat'];
   $a="SELECT *
FROM ip_pat_admit
WHERE PAT_ID='$pat_id' AND pat_no =  '$patno'";
...
if($sql1)
{
	...
	$a1="SELECT * FROM patientregister WHERE  registerno =  '$regno'";
$sql12 = mysqli_query($link,$a1) or die(mysqli_error($link));
	$row12 = mysqli_fetch_array($sql12);
	
	
	$PAT_NO = $row1['PAT_NO'];
	$patname = $row12['patientname'];
...
<input type="hidden" name="ipno" value="<?php echo ($PAT_NO);?>"/>
...
<?php
	...
	if($sql)
	{
		while($row = mysqli_fetch_array($sql))
		{
			...
			$dname = $row['dname1'];
?>
<option value="<?php echo $did ?>" <?php if($doc_code==$did){ echo 'selected';} ?>><?php echo $dname ?></option>
<?php
		}
	}	
?>
											...
											<div class="form-group">
												...
												<input type="text" class="form-control" value="<?php echo $age?>" name="age" id="age" readonly />
											</td></tr></table>
  ...
  ?>
    ...
    <option value="<?php echo $room_no?>"><?php echo $roomno?></option>
								...
								<!--	<div class="form-group">
											...
											<input name="roomrents" type="text" class="form-control" value="<?php echo $room_rent?>"  id="roomrents"  size="8" />
											...
											<div class="form-group">
	                                          ...
	                                          <input type="text" name="rupees" value="<?php echo $adv_amnt?>" id="rupees" onKeyUp="return validate(document.myform.rupees.value)" class="form-control"/>
	                                        </div>
											
											<div class="form-group">
	                                            <label> Received By</label>
												<input name="emp_name" type="text" class="form-control" value="<?php echo $AUTH_BY; ?>" />
	                                        </div>
											<div class="form-group">
 ...
 /></td></tr></table>
										 ...
										 <div class="form-group">
                                            <label>Patient Name :</label>
											 ...
											 <input name="pname" id="patname" readonly="readonly" value="<?php echo $patname ?>"  class="form-control" type="text"  size="20"  required="required"
 />
										...
										<div class="form-group">
                                            <label>Gender :</label>
											 ...
											 <input name="sex" id="gen1" readonly="readonly"  class="form-control" type="text" value="<?php echo $gender?>"  size="20"  required="required"
 />
