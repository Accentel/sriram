...
<tr><td colspan="2"> <h2 align="center" style="font-size:18px;"><b><u>Daycare Bill</u></b></h2></td></tr>
  ...
  <tr>
	...
	<tr>
          <td height="100" colspan="3" align="center"><input type="button" value="Print" id="prnt" class="butt" onclick="prnt();"/> <a href="daycarebilllist.php"><input type="button" value="Close" id="cls" class="butt"/></a></td>
      </tr>
