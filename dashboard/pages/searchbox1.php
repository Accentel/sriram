...
<?php 
$sql="select distinct product_name from phr_purinv_dtl order by PRODUCT_NAME ASC ";  // Query to collect records
...
$sql="select  (a.S_RATE / a. balance_qty) as final_count,a.PRODUCT_NAME,a.packing_type,a.batch_no,a.mrp,a.exp_date,a.BATCH_NO,
a.s_qty,a.s_free,a.s_rate,a.noitems,a.cost,c.suppl_name,a.S_RATE from phr_purinv_dtl a inner join phr_purinv_mast b on  a.lr_no=b.lr_no inner join phr_supplier_mast c on c.SUPPL_CODE=b.SUPPL_CODE where a.PRODUCT_NAME='$name' group by b.SUPPL_CODE";
