...
$r=mysqli_fetch_array($sq);
                                    ...
                                    <form action="" id="form_sample_1" class="form-horizontal" autocomplete="on" method="post" enctype="multipart/form-data">
                                        <div class="form-body">
										 <div class="form-group row">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="date" name="bdate"  value="<?php echo $r['bdate']; ?>"  id="bdate" placeholder="Enter Bill NO" class="form-control" required/> 
												</div>
												<div class="col-md-2">
                                                    <input type="text" name="time"  value="<?php echo $r['btime']; ?>"  id="time" placeholder="Enter Time" class="form-control" /> 
												</div>
                                    	</div>
                                        ...
                                        <div class="form-group row">
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="patient-cateory" id="patient-cateory" class="form-control" value="<?php echo $r['patientcategory']; ?>"/>
                                                </div>
 ...
 $a="SELECT * FROM final_bill_genral where id1='$id' ";
 $query = mysqli_query($link,$a);
												   ...
												   <!--<td><input type="text" name="remarks[]"  data-row="<?php echo $i; ?>" id="remarks" value="<?php echo $y['remarks'];?>"/></td>-->
...
-->
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="now_pay" id="now_pay" VA placeholder=" Pay Amount" class="form-control" value="<?php echo $r['namount'];?>"/>
                                                </div>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="now_bal" id="now_bal" readonly placeholder=" Balance Amount" class="form-control" value="<?php echo $r['new_bal'];?>"/>
                                                </div>
                                           ...
                                           <div class="form-actions">
                                            <div class="row">
                                                <div class="offset-md-3 col-md-9">
                                                   <?php if($ses=='admin'){?>
												   <button type="submit" name="Submit1" class="btn btn-info">Submit</button><?php }?>
