...
include("header.php");?>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header><meta http-equiv="Content-Type" content="text/html; charset=utf-8">User Management</header>
		...
		<div class="checkcust" align="left" style="margin-top:10px;margin-bottom:10px;margin-left:10px;">
			...
			<input type="checkbox" name="menu[]" value="26" />&nbsp;&nbsp; Lab Test Details<br>
			  <input type="checkbox" name="menu[]" value="24" />&nbsp;&nbsp; Add Procedure Details <br>
			 ...
			 <input type="checkbox" name="menu[]" value="200" />&nbsp;&nbsp; Add Hospital Tarrif List <br>
			 	 <input type="checkbox" name="menu[]" value="0200" />&nbsp;&nbsp; Update Validity Days <br>
				 <input type="checkbox" name="menu[]" value="0201" />&nbsp;&nbsp; Add City  <br>
				  <input type="checkbox" name="menu[]" value="0202" />&nbsp;&nbsp; Add Mandal  <br>
				   <input type="checkbox" name="menu[]" value="0203" />&nbsp;&nbsp; Add Address  <br>
		...
		<div class="checkpur" align="left" style="margin-top:10px;margin-bottom:10px;margin-left:10px;">
			...
			<input type="checkbox" name="menu[]" value="52" />&nbsp;&nbsp; Patient History<br>
		</div>
		</td>
        <td ></td>
		...
		<input type="checkbox" name="menu[]" value="0204" />&nbsp;&nbsp; All Patients Report<br>
			<input type="checkbox" name="menu[]" value="0205" />&nbsp;&nbsp; IP Room Transfer<br>
				<input type="checkbox" name="menu[]" value="0206" />&nbsp;&nbsp; Patient History<br>
		</div>
		</td>
        <td ></td>
		...
		<div class="checkinv" align="left" style="margin-top:10px;margin-bottom:10px;margin-left:10px;">
			...
			<!--<input type="checkbox" name="menu[]" value="63" />&nbsp;&nbsp; Daycare Bill<br>-->
				<input type="checkbox" name="menu[]" value="63" />&nbsp;&nbsp; Procedure Bill<br>
			...
			<input type="checkbox" name="menu[]" value="66" />&nbsp;&nbsp; Final Bill<br>
		...
		<div class="checkinv" align="left" style="margin-top:10px;margin-bottom:10px;margin-left:10px;">
		<input type="checkbox" name="menu[]" value="151" />&nbsp;&nbsp; OP Cancel<br>
		...
		<div class="checkinv" align="left" style="margin-top:10px;margin-bottom:10px;margin-left:10px;">
			  ...
			  <input type="checkbox" name="menu[]" value="996" />&nbsp;&nbsp; Stock Adjustment<br>
		...
		<div class="checkinv" align="left" style="margin-top:10px;margin-bottom:10px;margin-left:10px;">
			<!--<input type="checkbox" name="menu[]" value="121" />&nbsp;&nbsp; <B>RECEPTION</B><br>-->
                ...
                <input type="checkbox" name="menu[]" value="12912" />&nbsp;&nbsp; Year Wise  Report<br>
                 <input type="checkbox" name="menu[]" value="12913" />&nbsp;&nbsp; Discount Wise  Report<br>
                  <input type="checkbox" name="menu[]" value="12914" />&nbsp;&nbsp; Procedure Bill  Report<br>
                 
                 <input type="checkbox" name="menu[]" value="12915" />&nbsp;&nbsp; Test Wise Lab Report<br>
				   <input type="checkbox" name="menu[]" value="12916" />&nbsp;&nbsp; Test Wise Procedure Report<br>
				   <input type="checkbox" name="menu[]" value="12917" />&nbsp;&nbsp; Procedure Due Bill Report<br>
				   
				    <input type="checkbox" name="menu[]" value="12918" />&nbsp;&nbsp; Lab Due Bill Report<br>
				   
				  <!--&nbsp;&nbsp;   <input type="checkbox" name="menu[]" value="125" />&nbsp;&nbsp; Total Expenses Report<br>-->
				  &nbsp;&nbsp;   <input type="checkbox" name="menu[]" value="1205" />&nbsp;&nbsp; Dialy Amount Collected Report<br>
