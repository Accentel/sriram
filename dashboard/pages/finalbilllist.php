                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class="pull-left">
                                <div class="page-title">Final Bill Insurance List</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Final Bill Insurance</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
					                        ...
					                        <div class="col-md-12">
					                            <div class="card card-topline-red">
													...
													<?php echo $i; ?>					
																	...
																	<td class="left"><?php echo $res['new_bal']; ?></td>
																	

																
																	
																	<td>
																		<a href="edit_final1.php?id=<?php echo $res['id']; ?>" class="btn btn-primary btn-xs">
																			<i class="fa fa-pencil"></i>
																		</a>
																			<a href="due_finalbill.php?id=<?php echo $res['id'] ?>"  >
																			<img src="../img/income.png" />
																		</a>
																		<a href="print_idischarge2.php?id=<?php echo $crud->my_simple_crypt($res['id'],'e'); ?>" class="btn btn-primary btn-xs">
