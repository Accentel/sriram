...
function stateChanged(){ 
	...
	//alert('<%=current_date%>')
			...
			opener.document.getElementById("patient-cateory").value=strar[21];
...
<?php 
             ...
             <tr height="25px"><td style="text-align:center;"><input type="radio" name="empid" value="<?php echo $a ?>" onclick="javascript:showDoc(this.value);"/></td><td><?php echo $a ?></td><td><?php echo $h;?></td></tr>
				 ...
				 <?php }
				  ...
				  $x="select distinct a.PAT_NO,b.patientname,b.registerno from ip_pat_admit as a,patientregister as b WHERE a.PAT_REGNO=b.registerno AND a.DIS_STATUS='ADMITTED'  order by b.reg_id desc";
