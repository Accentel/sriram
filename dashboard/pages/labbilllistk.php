															...
															<?php $i=1;	foreach ($result as $key => $res) { ?>
																<tr class="odd gradeX">
																	...
																	<a  onclick="return confirm('Are you sure you want to Print this item?');" href="delete_proc.php?id=<?php echo $res['id'];?>"><button class="btn btn-danger btn-xs">	
																			...
																			<?php }?>
																				<a href="" onclick="window.open('print_pplabbillk.php?id=<?php echo $res['billno']; ?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" class="btn btn-primary btn-xs">
																			<i class="fa fa-print"></i>
																		</a>
																	</td>
