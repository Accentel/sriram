...
<b><img src="plogo.png" width="16" height="16"/> <?php echo $HOSP_NAME; ?></b><br>
...
<?php  $HOSP_NAME ?></div></td><td style="width:100%; float:left;">
                     ...
                     <div   class="" >DL No. :TS/RR/2020-55879</div>
		...
		<!--<tr height="5px"></tr>
         ...
         <tr style=" text-transform: uppercase;">
            ...
            <td width="20%" align="left"> </td>
             ...
             <td width="25%" ><div align="left"><span class="label1"> Date</span>: <?php // $lr_id ?><?php echo date('d/m/Y',strtotime($saledate)); ?> </div></td>
            <td width="20%" align="left"> </td>
          </tr>
