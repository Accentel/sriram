...
<?php 
$sql="select distinct address from patientregister where  pcancel='' ";  
$r=mysqli_query($link,$sql) or die(mysql_error());
while ($row=mysqli_fetch_array($r)) {
...
<td>
					                                    ...
					                                    <div class="table-scrollable">
															...
															$sq=mysqli_query($link,"select * from patientregister  where regdate='$d' and pcancel='' and status='' order by reg_id desc");
															}
															$i=1;
					 ...
					 if($pay_type=='OP'){ echo 'Out Patient' ; } else if($pay_type=='IP') { echo 'IN Patient'; }
			 else if($pay_type=='Insurance') { echo 'Insurance'; }else if($pay_type=='Physiotherapy') { echo 'Physiotherapy';
			 }
                             ...
                             ?>                                      </td>
																	...
																	<td><?php echo  $r['age'];?>/<?php echo $r['gender']; ?></td>
																		...
																		<td class="left"><?php echo $b=date("d-m-Y", strtotime($r['regdate']));?></td>
															
															<?php if($ses!='admin'){ ?>
																		<td>
																		    
																<a onclick="return confirm('Are you sure you want to Print this item?');" href="../modal/print.php?id=<?php echo $r['reg_id'];?>">
