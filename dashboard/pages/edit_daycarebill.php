										...
										<?php }else{}?>
											<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
		                                                ...
		                                                <input class="form-control " size="16" placeholder="Bill Date" type="date" value="<?php echo $bdate; ?>" name="bdate" id="bdate">
											...
											<table class=" full-width" >
															...
															?>
															 <tr>
					                                                ...
					                                                <th> <input type="text" name="amount[]" value="<?php echo $t1['amount']; ?>" <?php if($ses=='admin'){echo '';}else{ echo 'readonly';} ?>  placeholder="" class="form-control col-md-4 txt" /> 
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="tamount" data-required="1" id="tamount"  value="<?php echo $tamount; ?>" placeholder="Enter Total Amount" class="form-control" <?php if($ses=='admin'){echo '';}else{ echo 'readonly';} ?> required/> 
                                            ...
                                            <label class="control-label col-md-2">Discount
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="discount"  value="<?php echo $discount; ?>" id="discount" placeholder="Enter Discount" <?php if($ses=='admin'){echo '';}else{ echo 'readonly';} ?> class="form-control txt1" /> </div>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="namount"  id="namount"  value="<?php echo $namount; ?>" placeholder="Enter Net Amount" <?php if($ses=='admin'){echo '';}else{ echo 'readonly';} ?> class="form-control" required/> 
                                            ...
                                            <label class="control-label col-md-2">Paid Amount
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="pamount"  id="pamount" placeholder="Enter Paid Amount" value="<?php echo $pamount; ?>"  <?php if($ses=='admin'){echo '';}else{ echo 'readonly';} ?> class="form-control txt2" /> </div>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="balamount"  id="balamount"  value="<?php echo $bamount; ?>" placeholder="Enter Balance Amount" class="form-control" <?php if($ses=='admin'){echo '';}else{ echo 'readonly';} ?> required/> 
