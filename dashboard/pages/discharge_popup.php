...
function stateChanged(){ 
	...
	//alert('<%=current_date%>')
			...
			opener.document.getElementById("patno").value=strar[3];
			opener.document.getElementById("age").value=strar[4];
			opener.document.getElementById("sex").value=strar[5];
			opener.document.getElementById("doa").value=strar[6];
			opener.document.getElementById("address").value=strar[7];
...
<?php 
             ...
             <tr height="25px"><td style="text-align:center;"><input type="radio" name="empid" value="<?php echo $a ?>" onclick="javascript:showDoc(this.value);"/></td><td><?php echo $a ?></td><td><?php echo $h;?></td></tr>
				 ...
				 <?php }
				  ...
				  $x="select distinct a.PAT_NO,b.patientname,b.registerno from ip_pat_admit as a,patientregister as b WHERE a.PAT_REGNO=b.registerno  order by b.reg_id desc";
