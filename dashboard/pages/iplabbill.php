...
xmlhttp.open("GET","search1016.php?q="+str,true);
xmlhttp.send();
}
                                ...
                                <div class="card-body" id="bar-parent">
                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
										...
										<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
												<input type="radio" name="ptype" value="OP" onClick="window.location.href='labbill.php';" />&nbsp;OP&nbsp;<input type="radio" name="ptype" value="IP" checked />&nbsp;IP&nbsp;<input type="radio" name="ptype" value="Genearal"  onClick="window.location.href='glabbill.php';"/>&nbsp;General
...
$r2=mysqli_fetch_array($qs);
 ...
 $reg=(($new."0000".$y));
                                           ...
                                           <label class="control-label col-md-2">Time
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="mobile" data-required="1" id="patcategory" placeholder="Enter patcategory" class="form-control" /> </div>
...
<button type="button" class='btn btn-danger delete'>-</button>
	...
	<?php 
	$u=mysqli_query($link,"select * from labtest1") or die(mysqli_error($link));
