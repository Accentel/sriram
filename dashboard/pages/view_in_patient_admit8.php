            ...
            <td width="20%"><div align="left"><b>Patient Name : </b></div></td>
                 <td ><div align="left"><b>Age/Gender :</b> </div></td>
                  ...
                  <td width="20%"><div align="left"><b>Date : </b> </div></td>
                    <td width="20%"><div align="left"><b>Patient Type : </b> </div></td>
...
$i=1;
          $x="select registerno,patientname,age,gender,doctorname,regdate,phoneno,address,paid,pat_type from patientregister where  
  regdate between '$sdate' and '$edate' ";
...
while($r=mysqli_fetch_array($qry1)){?>
        ...
        <tr>	
          ...
          <td><?php echo $r['phoneno']; ?></td>
			...
			<td ><?php  $d=$r['regdate'];  echo date("d-m-Y", strtotime($d)); ?></td>
			<td ><?php  echo $r['pat_type'];  ?></td>
            <td><?php echo $t1=$r['paid'];?></td>
            </tr>
            <?php $t=$t1+$t;  $i++;}?>
             <tr><th colspan="9" align="right">Total Amount</th><th><?php echo $t;?></th></tr>
