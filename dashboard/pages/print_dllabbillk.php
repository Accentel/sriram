...
<THEAD>
<tr><td colspan="2" style="height:120px;"><!--<img src="../img/raajtop.png" style="width:100%; height:120px;"/> --> </td></tr>
<tr><td colspan="2"> <h2 align="center" style="font-size:18px;"><b><u> Lab Bill</u></b></h2></td></tr>
	...
	<?php
			...
			$crud = new Crud();
			$bno = $_REQUEST['id'];
			$ty="select * from duebill where bill_num='$bno'";
			$t = $crud->getData($ty);
			...
			$total =$row['pamount'];
				...
				$ty1="select * from bill where billno='$billno' and mrno='$mrno'";
		
					$t1 = $crud->getData($ty1);
						foreach($t1 as $key=>$row1)
			{
				$age = $row1['age'];
				$gender = $row1['gender'];
				$dname = $row1['dname'];
				$ptype = $row1['ptype'];
				$patient_category = $row1['patient_category'];
	...
	<table width="100%" border="0" align="center"  cellpadding="0" cellspacing="0" >
         <tr>
          ...
          <td style="padding-left:20px;"><div align="left">Mr No </div></td>
            ...
            <td style="padding-left:20px;" width="20%"><div align="left">Date </div></td>
			<td style="padding-left:20px;" width="30%"> : <?php echo $bdate ?></td>
        </tr>
          <tr>
         <tr>
         ...
         <td style="padding-left:20px;"><div align="left">Age / Sex </div></td>
		  ...
		  <tr>
			...
			<table align="center" width="100%" style="border-top:1px solid #000000;border-bottom:1px solid #000000;" cellpadding="0" cellspacing="0">
				<tr >
					<td width="70%" style="padding-left:50px;" align="left" ><b><u>Particulars</u></b></td>
					<td align="left" style="padding-left:50px;" ><b><u>Amount</u></b></td>
				</tr>
		
				<tr>
				
				<td style="padding-left:50px;" align="left">Lab Due Bill</td>
				<td  style="padding-left:60px;" align="left"><?php echo number_format($total,2) ?></td>
				</tr>
...
$number = $total;
 ...
 ?> 
         ...
         <tr>
            <td class="label1"  colspan="4"><br/><br/></td>
			  
            </tr>
				<tr>
            
            <td colspan="2">Created By:<?php echo $user; ?><br/>Created Date:<?php echo date('d-m-y h:i:s a'); ?> </td>
			<td  colspan="2" align="right" style="padding-right:20px;"  >  <b>Authorized Signature</b> </td>
            </tr>
...
<tr>
          ...
          <a href="labbilllist.php"><input type="button" value="Close" id="cls" class="butt" onclick="window.close();"/></a></td>
      </tr>
    </table>
        </TBODY>
