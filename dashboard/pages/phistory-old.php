	                                    ...
	                                    <div class="col-md-6 col-sm-6">
	                                        ...
	                                        <div class="form-group">
	                                            <label>MR No:</label>
												 ...
												 <input id="mrno" list=\"city1\" class="form-control" name="mrno" onclick="window.open('wrno3.php','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')"  >
