...
$sql1 = mysqli_query($link,"select product_code,product_name,packing_type,batch_no,mrp,exp_date,s_qty,s_free,s_rate,discount,value,vat,vat_amt,mfg_date,noitems,cost,manu_by,inv_id,sgst,cgst,tqty,each_pur_rate,each_mrp_rate,feach_pur_rate from phr_purinv_dtl where lr_no='$lr_id'");
