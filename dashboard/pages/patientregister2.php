...
<?php } } ?>
											...
											<div class="form-group" style="display:none" >
												...
												<option value="Insurence">Insurence</option>
												 ...
												 <div class="form-group" >
                                            <label>Address </label>
											<textarea class="form-control" required name="village"><?php echo $address?></textarea>
 ...
 />		
									   ...
									   <div class="form-group">
											...
											<input type="text" class="form-control" value="<?php echo $aadar;?>"  name="aadhar" id="aadhar"  />
