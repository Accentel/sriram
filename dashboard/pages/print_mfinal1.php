...
window.print();
self.location='daycarebilllist.php';
}
function closew(){
window.close();
}
...
<tr><td colspan="2"> <h2 align="center" style="font-size:18px;"><b><u>Final Bill</u></b></h2></td></tr>
	...
	<?php
			...
			$ty="select * from mfinalbill where billno='$bno'";
			$t = $crud->getData($ty);
  ...
  <tr>
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
         ...
         <tr>
		  ...
		  <tr>
			...
			<?php	
				 $sql1="SELECT testname,amount FROM mfinalbill1 WHERE bno = '$bno'";
				$y=$crud->getData($sql1);
	...
	<tr>
          <td height="100" colspan="3" align="center"><input type="button" value="Print" id="prnt" class="butt" onclick="prnt();"/> <a href="mfinalbilllist.php"><input type="button" value="Close" id="cls" class="butt"/></a></td>
      </tr>
