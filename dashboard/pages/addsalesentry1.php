...
<table width="100%" border="0" class="table" cellspacing="0" cellpadding="0">
 ...
 onclick="window.open('finalbill_popupk2.php','mypatwindow','width=500,height=500,toolbar=no,resizable=yes,menubar=no,scrollbar=yes')"/></td>
       ...
       <!--           
 <tr style="display:none" id="trpatk7">
 ...
 onclick="window.open('finalbill_popupk2.php','mypatwindow','width=500,height=500,toolbar=no,resizable=yes,menubar=no,scrollbar=yes')"/>
 <input type="text" class="text" name="custname3" id="custname3" onfocus="patientdetails(this.value)"/>-->
...
function nett1xxx(str){
                            ...
                            <td width="19%" align="left"><input name="grand" type="text" class="text" id="grand"  readonly="readonly" value="0"/></td>
                             ...
                             <tr id="cashtr" style="display:''">
							  <td class="label1"><div align="right"> Adjust:</div></td>
							  <td align="left"><input name="adjust" type="text" class="text" value="0" id="adjust" onchange="nett1xx(this.value)" onkeyup='nett1xx();' /></td>
							  </tr>
							 <tr id="cashtr" style="display:''">
							  <td class="label1"><div align="right"> Round:</div></td>
							  <td align="left"><input name="round" type="text" class="text" value="0" id="round" onchange="nett1x(this.value)" onkeyup='nett1x();' /></td>
							  </tr>
							
							  <tr id="cashtr" >
							
							<td width="85%" class="label1"><div align="right"> Final Amount:</div></td>
                            <td width="19%" align="left"><input name="final" type="text" class="text" id="final"  readonly  value="0"/></td>
							</tr>
