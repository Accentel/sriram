                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
										...
										<?php }else{}?>
                                           ...
                                           <label class="control-label col-md-2">Time
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="patcategory" data-required="1" id="patcategory" placeholder="Enter patcategory" class="form-control" value="<?php echo $res['patient_category']; ?>" /> </div>
...
<button type="button" class='btn btn-danger delete'>-</button>
							...
							<?php }else{} ?>				<div class="form-group row">
											<div class="col-md-12">
