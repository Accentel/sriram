...
$edate = date('Y-m-d',strtotime($end_dt));
$i=1;
           $x="select registerno,patientname,age,gender,doctorname,date,phoneno from patientregister where pat_type='OP' and 
  date between '$sdate' and '$edate' and `doctorname`='$doct' ";
