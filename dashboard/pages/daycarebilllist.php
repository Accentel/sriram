															...
															<?php $i=1;	foreach ($result as $key => $res) { ?>
																<tr class="odd gradeX">
																	...
																	<td>
																		...
																		<a href="" onclick="window.open('print_daycare1.php?id=<?php echo $crud->my_simple_crypt($res['billno'],'e'); ?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" class="btn btn-primary btn-xs">
