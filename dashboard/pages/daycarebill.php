                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header><meta http-equiv="Content-Type" content="text/html; charset=utf-8">Daycare Bill</header>
                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group row" id="mid">
											...
											<div class="form-group row">
												...
												$dxx1=date($y.'-01-01');
$d2=date($y.'-12-31');
 $aa="select max(`reg_no`) as id from daycarebill where bdate between '$dxx1' and '$d2'  ";
...
<button type="button" class='btn btn-danger delete'>-</button>
	...
	<?php 
	$u=mysqli_query($link,"select * from daycare") or die(mysqli_error($link));
	while($u1=mysqli_fetch_array($u)){
	?>
	<option value="<?php echo $u1['dname']; ?>"><?php echo $u1['dname']; ?></option>
	<?php }?>
	</select></td>
...
data +="<td><select name='tname[]'  id='tname"+i+"' data-row='"+i+"' style='width:300px;' class='form-control'  onChange='showHint("+i+")'><option value=''>Select Test Name</option>";
	...
	while($u1=mysqli_fetch_array($u)){
	?>
	data +="<option value='<?php echo $u1["dname"]; ?>'><?php echo $u1["dname"]; ?></option>";
	<?php }?>
	data +="</select></td>";
