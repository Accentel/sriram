...
<THEAD>
<tr><td colspan="2" style="height:80px;"><!--<img src="../img/raj logo.jpeg" style="width:100%; height:120px;"/>  --></td></tr>
         ...
         <tr>
          ...
          <tr>
           ...
           <td style="padding-left:20px;" width="15%"><div align="left">Bill No. </div></td>
			...
			<td style="padding-left:20px;"> : <b><?php echo $patient_category ?></b></td>
...
$number = $paid;
 ...
 ?> 
	...
	<tr>
          <td height="100" colspan="3" align="center"><input type="button" value="Print" id="prnt" class="butt" onclick="prnt();"/> <a href="labbill.php"><input type="button" value="Close" id="cls" class="butt" /></a></td>
      </tr>
