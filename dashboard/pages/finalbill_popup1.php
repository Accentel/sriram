...
B.gaurdianname,B.phoneno,B.insutype_name,ADMIT_DATE from ip_pat_admit as A,patientregister as B WHERE
...
if($query){
 ...
 //$x="";
   ...
   $y="select sum(namount) as net,sum(pamount) as paid,sum(bamount) as bal from bill where mrno='$regno' and bdate between '$admitdate1' and '$edate'  ";
...
$sql3=mysqli_query($link,$y); 
  ...
  $y="select sum(namount) as net,sum(pamount) as paid,sum(bamount) as bal from bill_proc where mrno='$regno' and bdate between '$admitdate1' and '$edate'  ";
...
if($proc_bal==''){
 ...
 echo $data=":".$emp_id.":".$patname.":".$regno.":".$age.":".$gender.":".$addr1.":".$doctorname.":".$gaurdianname.":".$phoneno.":".$admitdate.":".$lab_net.":".$lab_paid.":".$lab_bal.":".$phr_net.":".$phr_paid.":".$phr_bal.":".$advh.":".$proc_net.":".$proc_paid.":".$proc_bal.":".$insutype_name;
