...
<input type="radio" required="required"  name="new" id="new" value="New"  /> New 
<input type="radio" onclick="javascript:location.href='patientregister2.php'" required="required" checked  name="new" id="new" value="Existing"/> Existing</td>
...
while ($row=mysqli_fetch_array($r)) { ?>
<option value="<?php echo $dd=$row['dname1'] ?>" ><?php echo $row['dname1'] ?></option> 
<?php }
...
?>
											 ...
											 <div class="form-group">
	                                          ...
	                                          <input type="text"  name="con_fee"    id="con_fee" class="form-control" value=""/>
	                                        </div>
                                                ...
                                                <label class="control-label ">Paid Amount
												   ...
												   <input type="text" name="paid" id="paid" class="form-control" onKeyup="ptest()"  required value="">
