...
$k="select * from  final_bill_fin1 where  id='$bno'";
$t = $crud->getData($k);
foreach($t as $key=>$r){
$id1=$r['id'];
$mrno=$r['mrno'];
...
<h3 align="center">FINAL BILL DETAILS</h3>
                                                   ...
                                                   <table  width="100%" cellpadding="2px"  border="0" width="100%" style="overflow: wrap" >
												   <tr>
												       <td><b>S No</b></td>
												   ...
												   $crud = new Crud();
$bno = $crud->my_simple_crypt($_REQUEST['id'],'d');
$k="select * from  final_bill_genral1 where  id1='$bno' and days>=1";
$t = $crud->getData($k);
$i=1;
foreach($t as $key=>$y){
