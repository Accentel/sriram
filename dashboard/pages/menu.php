	                          ...
	                          <li class="nav-item  ">
	                            ...
	                            <ul class="sub-menu">
	                                ...
	                                <li class="nav-item  ">
	                                 ...
	                                 <li class="nav-item  ">
	                                    <a href="op_report.php" class="nav-link "> <span class="title">Out Patient History Card</span>
	                                    </a>
	                                </li>
	                                ...
	                                <li class="nav-item  ">
	                                    <a href="opdigitalform.php" class="nav-link "> <span class="title">OP Digital Form</span>
	                                    </a>
	                                </li>-->
	...
	window.open('admit_patients1.php','Mywindow','width=1020,height=800,toolbar=no,menubar=no');
	                       ...
	                       <li class="nav-item  ">
	                            ...
	                            <ul class="sub-menu">
	                                ...
	                                <li class="nav-item  ">
	                                    <a href="dispatient.php" class="nav-link "> <span class="title">Discharged Parients</span>
	                                    </a>
	                                </li>
	                        ...
	                        <li class="nav-item  ">
								...
								<li class="nav-item  ">
	                               ...
	                               <li class="nav-item  ">
	                                 ...
	                                 <!--<li class="nav-item  ">
	                                    <a href="mfinalbilllist.php" class="nav-link "> <span class="title">Manual Final Bill</span>
	                                    </a>
	                                </li>
	                                <li class="nav-item  ">
                      ...
                      Pharmacy History With Amount</span></a></li>
                            ...
                            <li class="nav-item  ">
	                            ...
	                            <ul class="sub-menu">
									...
									<li class="nav-item  ">
	                                    <a href="year.php" class="nav-link "> <span class="title">Year wise Report </span>
	                                    </a>
	                                </li>
									<li class="nav-item  ">
