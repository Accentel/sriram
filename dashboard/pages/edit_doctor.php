...
$sql1 = mysqli_query($link,"select * from doctdept");
	...
	{
?>
<option value="<?php echo $did=$row['id'] ?>" <?php if($dept==$did){ echo 'selected';} ?>><?php echo $row['doctdeptname'] ?></option>
<?php		
	}
...
<?php $doct_type=$r['doct_type'];
									...
									<option value="Yes">Yes</option><?php }?>
									   ...
									   -->
											...
											<div class="form-group">
                                            <label>Op Fee </label><table><tr><td>General
											...
											</td><td>Emergency<input type="text" class="form-control"  value="<?php echo $r['op_fee1'];?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="op_fee1" id="op_fee1" onfocus="calc()">
									   </tr></table></div>
									  <!-- <div class="form-group">
