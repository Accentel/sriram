...
<td><strong>Age/Gender</strong></td><td>  :</td> <td><?php  echo $age."/". $sex."&nbsp;&nbsp;";?></td>
 ...
 <tr>
<td><strong>Consultant</strong></td><td>  :</td>  <td><?php  echo $doctor;?></td>


</tr>
 <tr>
<td><strong>Department</strong></td><td>  : </td> <td><?php  echo $doctor;?></td>
...
<tr>
<td><strong>Dcceased Date</strong></td><td>  :</td>  <td><?php echo date('d/m/Y',strtotime($discharge));  ?></td>


</tr>
<tr>
<td><strong>Diagnosis</strong></td><td>  : </td> <td><b><?php echo $r['final_diefg'];  ?></b></td>


</tr>
<tr>
<td><strong>Treetment</strong></td><td>  :</td>  <td><?php echo $r['treetment'];  ?></td>
...
<hr/>
 ...
 <tr><td colspan="3">
												   ...
												   <td> <?php echo $room_days;?></td>
												   <td> <?php echo $room_rent;?></td>
												   <td style="border-right:#FFF;"> <?php echo $room_charges;?></td>
												  ...
												  <tr style="border-left:#FFF !important;">
												   ...
												   <td> <?php echo $nurs_days;?></td>
												   <td> <?php echo $nurs_rent;?></td>
												   <td style="border-right:#FFF;"> <?php echo $nurs_charges;?></td>
												   ...
												   <td> <?php echo $prof_days;?></td>
												   <td> <?php echo $prof_rent;?></td>
												   <td style="border-right:#FFF;"> <?php echo $prof_charges;?></td>
												...
												<tr style="border-left:#FFF !important;">
												   ...
												   <td> <?php echo $inv_days;?></td>
												   <td> <?php echo $inv_rent;?></td>
												   <td style="border-right:#FFF;"> <?php echo $inv_charges;?></td>
												   ...
												   <td> <?php echo $phr_days;?></td>
												   <td> <?php echo $phr_rent;?></td>
												   <td style="border-right:#FFF;"> <?php echo $phr_charges;?></td>
