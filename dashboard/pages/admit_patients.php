        ...
        <table cellpadding="0" cellspacing="0" width="100%" border="0">
            ...
            <tr>
                <td>
					...
					from patientregister a ,ip_pat_admit b where b.ADMIT_DATE between '$sdate1' and '$edate1' and    a.registerno=b.PAT_REGNO and b.DIS_STATUS='ADMITTED'  order by a.registerno asc";
