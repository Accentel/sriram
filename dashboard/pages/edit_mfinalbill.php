                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Manuval Final Bill</header>
                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
										...
										<?php }else{}?>
											...
											<table class=" full-width" >
					                                        ...
					                                        <tbody>
															<?php 
															$yk="select * from mfinalbill1 where bno='$bno1' and mrno='$mrno'";
															$tu=$crud->getdata($yk);
															$i=100;
															...
															?>
															 <tr>
					                                                ...
					                                                <th> <input type="text" <?php if($ses=='admin'){echo '';}else{ echo 'readonly';} ?> name="amount[]" value="<?php echo $t1['amount']; ?>"  placeholder="" class="form-control col-md-4 txt" /> 
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="tamount" data-required="1" id="tamount" <?php if($ses=='admin'){echo '';}else{ echo 'readonly';} ?> value="<?php echo $tamount; ?>" placeholder="Enter Total Amount" class="form-control" required/> 
                                            ...
                                            <label class="control-label col-md-2">Paid Amount
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="pamount"  id="pamount" <?php if($ses=='admin'){echo '';}else{ echo 'readonly';} ?> placeholder="Enter Paid Amount" value="<?php echo $pamount; ?>" class="form-control txt2" /> </div>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="balamount"  id="balamount" <?php if($ses=='admin'){echo '';}else{ echo 'readonly';} ?> value="<?php echo $bamount; ?>" placeholder="Enter Balance Amount" class="form-control" required/> 
