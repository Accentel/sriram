...
{
$ses=$_SESSION['user']; 
include('../db/insert_mfinalbill.php');
...
xmlhttp.open("GET","searchd116.php?q="+str,true);
xmlhttp.send();
}
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Manual Final Bill</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Manual Final Bill</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header><meta http-equiv="Content-Type" content="text/html; charset=utf-8">Manual Final Bill</header>
                                ...
                                <div class="card-body" id="bar-parent">
                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
										...
										<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                  <!--  <select  name="ptype" id="ptype" class="form-control" required onchange="showuser(this.value);">
													...
													</select>-->									<input type="radio" name="ptype" value="OP" />&nbsp;OP&nbsp;<input type="radio" name="ptype" value="IP" />&nbsp;IP&nbsp;<input type="radio" name="ptype" value="General" />&nbsp;General
													</div>
													</div>
                                        ...
                                        <div class="form-group row" id="mid">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="mrno"  value="" id="mrno" placeholder="Enter MRNO" class="form-control mrno"   onclick="window.open('wrno1.php','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')"/>
											...
											<div class="form-group row">
												...
												$dxx1=date($y.'-01-01');
$d2=date($y.'-12-31');
$aa="select max(`reg_no`) as id from mfinalbill where bdate between '$dxx1' and '$d2'  ";
...
<button type="button" class='btn btn-danger delete'>-</button>
	...
	<td>	<input type="text" name="tname[]"  id='tname1' data-row='1' style="width:300px;" class="form-control" >
	</td>
	<td><input type='text' name='amount[]'    id='amount1' data-row='1' value='0' class='form-control col-md-4 txt' onkeyup='calculateSum()'/></td>
                                           ...
                                           <div class="form-actions">
                                            <div class="row">
                                                <div class="offset-md-3 col-md-9">
                                                    ...
                                                    <a href="mfinalbilllist.php"><button type="button" class="btn btn-default">Cancel</button></a>
                                                </div>
                                            	</div>
                                        	</div>
										</div>
...
data +="<td><input type='text' name='tname[]'  id='tname"+i+"' data-row='"+i+"' style='width:300px;' class='form-control'  ></td>";
	
	data +="<td><input type='text' name='amount[]' id='amount"+i+"'  data-row='"+i+"' value='0' class='form-control col-md-4 txt' onkeyup='calculateSum()' /></td>";
