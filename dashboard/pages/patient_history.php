...
?>
<tr>
<td colspan="3"><?php echo $tname=$y1['testname'] ?></td>
<td><a href="result_view.php?mrno=<?php echo $mrno; ?>&bno=<?php echo $bno;?>&tname=<?php echo $tname; ?>">View</a></td>
</tr>
...
<h3 align="center">Daycare  Bill</h3>
<table width="100%" border="1" cellspacing="0" cellpadding="0">
<tr>
...
<?php
//$mrnpo=$_GET['mrno'];
$query12=mysqli_query($link,"select * from discharge where mrno='$mrno'") or die(mysqli_error($link));
while($q112=mysqli_fetch_array($query12)){
 ?>
<tr>
...
<td><a href="medbill.php?lr_id=<?php echo $q1123['LR_NO']; ?>">View</a></td>
</tr>
