  ...
  <tr>
    <td colspan="2">
     <table width="100%" border="0" cellspacing="0" cellpadding="0"> <!--style="border:1px #BDD9E1 solid">-->
      ...
      <tr>
		...
		<table width="100%" border="1" align="center" style="vertical-align:text-top;color:#000;" cellpadding="1" cellspacing="0" >
          ...
          <tr>
            <td colspan="4" align="center"><b>Advance Bill Receipt</b></td>
             </tr>
          ...
          <tr>
			...
			<td colspan="3">: <?php echo $advamt ?></span></u></td>
            </tr>
     ...
     <tr ><td align="center"  colspan="2" valign="top" style=" border-top: #000000 0px solid;color:#000;"><table width="80%" border="0" align="center" v>
        <tr><td valign="top"><div align="left"><b>Prepared By:</b>&nbsp;<?php echo $authby ?><br/>
        <b>Printed Date:</b>&nbsp;<?php echo date('d-m-Y h:i:s a' );?></div></td><td valign="top"><div align="right"></div></td></tr></table></td></tr>
    </table></td>
  </tr>
     <tr>
