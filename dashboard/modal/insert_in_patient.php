...
if($sq){
	$qry1=mysqli_query($link,"insert into ip_pat_bed(PAT_NO,BED_NO,START_DATE,START_TIME,ALLOTED_BY,CURRENTDATE,AUTH_BY,room_no,room_type) 
	values('$pno','$bedno','$adate',str_to_date('$atime','%r'),'$allotby',now(),'$aname','$roomsno','$room_type')");
