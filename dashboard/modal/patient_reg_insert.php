...
echo $payment_type=$_POST['paytype'];
//exit;
...
date_default_timezone_set('Asia/Kolkata');
 ...
 `gender`, `address`, `phoneno`, `registerfee`, `remarks`, `pat_type`, `pay_type`, `aadar`, `ref_doc`, `ref_doc_mob`,
  ...
  bill_num,serv_name,hosp_fee,reg_no,opt_type,rec_no,image,visit_count_pat,have_ref,state,city,mandal,tnum,op_type,ageext,paid,due,regdate,regtime) VALUES 
  ('$doct','$doct3','$pname','$age','$fname' ,'$sex',
 '$addr','$mobile','$fee','$rmarks','$type','$payment_type','$aadhar','$ref_doc','$ref_mob','$con_doct_mob','$rel',
 '$ApplicationDeadline','$token','$con_fee','$total','$new','$pname_type','$valid','$payment_type','$dept','$insutype',
 '$policy','$chq_num','$bank','$chq_datse','$insutype_name','$policyno','$pkg_amt','$req_amt','$req_no','$apr_date','$ins_type',
 '$token1','$ser','$cnt','$serv_name','$ser_amt','$reg_no','$appoint_type','$rec_no','$iname1','1','$have_ref','$state','$city','$plac','$max','$op_type','$ageext','$paid','$due','$ApplicationDeadline','$time')"; 
...
values('Patient Register','$paid','$cnt','$doct','$ses','$payment_type','$ndate','$sdec','$new_doct_type')");
