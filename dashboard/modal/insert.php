...
if (isset($_POST['update_doct'])) {
   ...
   $checkBox = implode(',', $_POST['check_dept']);
		...
		`op_fee`='$op_fee',`ip_fee`='$ip_fee',`ins_fee`='$ins_fee',valdity='$valdity',
		visit_count='$visit_count',doct_dept_list='$checkBox',op_fee1='$op_fee1' where id='$id'"; 
...
$link->close();
 ...
 $hsn = $_POST['hsn'];
  $sch = $_POST['sch'];
			...
			UNIT_CODE='$UNIT_CODE',vattax='$vattax',pack_code='$pack_code',mani_by='$mani_by',sgst='$sgst',cgst='$cgst',prd_type_det='$prd_type_det',sch='$sch',hsn='$hsn' where id='$id'";  
