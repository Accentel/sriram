...
<?php
/*include("config.php");
$sql = mysqli_query($link,"select valid_days from validity_days") or die(mysqli_error($link));
if($sql){
...
<div class="book">
     <div class="page">
       ...
       <div ><img src="../pages/sriramlab.png" width="100%"/></div>
	...
	<td><span style="margin-left:-45px">Balance:</span>  <?php echo $due;?></td></tr>
         ...
         <!-- 
          ...
          <tr>
			...
			<div align="right" style="margin-top:-12px"><b> For Authorized Signature </b>  </div>
			</tr>
