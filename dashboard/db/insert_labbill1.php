...
if(isset($_POST['Submit'])) {	
	...
	$reg_no=$crud->escape_string($_POST['reg_no']);
		...
		$patcategory=$crud->escape_string($_POST['patcategory']);
...
date_default_timezone_set('Asia/Kolkata');
 $ndate=date( 'Y-m-d H:i:s', time ()); 
	...
	$sql = $crud->execute($aa);
		...
		$ts="INSERT INTO bill_proc(mrno,billno,bdate,pname,age,gender,dname,mobile,ptype,time,tamount,discount,namount,pamount,bamount,remarks,user,paymenttype,reg_no,patient_category,bill_num)VALUES
		('$mrno','$bno','$bdate','$pname','$age','$gender','$dname','$mobile','$ptype','$time','$tamount','$discount','$namount','$pamount','$balamount','$remarks','$user','$paymenttype','$reg_no','$patcategory','$cnt')";
