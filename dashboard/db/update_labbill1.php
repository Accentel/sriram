...
$mrno = $crud->escape_string($_POST['mrno']);
	...
	$patcategory=$crud->escape_string($_POST['patcategory']);
		 ...
		 $ts="update bill_proc set mrno='$mrno',billno='$bno',bdate='$bdate',pname='$pname',age='$age',gender='$gender',dname='$dname',mobile='$mobile',ptype='$ptype',time='$time',tamount='$tamount',discount='$discount',namount='$namount',pamount='$pamount',bamount='$balamount',remarks='$remarks',user='$user',paymenttype='$paymenttype',patient_category='$patcategory' where id='$id'";
